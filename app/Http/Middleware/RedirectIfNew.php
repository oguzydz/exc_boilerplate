...
class RedirectIfNew
{
    ...
    {
        if (Auth::user()->status != User::STATUS_ACTIVE AND Route::currentRouteName() != RouteServiceProvider::USER_STATUS_CONFIRMATION AND Route::currentRouteName() != RouteServiceProvider::USER_STATUS_CONFIRMATION_STORE) {
