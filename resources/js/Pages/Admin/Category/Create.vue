        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header font-bold">
                    <el-button type="primary" class="mr-2" icon="el-icon-back" v-on:click="$inertia.get(route('admin.category.index'))" size="mini">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group mb-2">
                            <label>Görsel</label>
                            <file-pond v-model="form.image" ref="pond" label-idle="Sürükle veya <span class='filepond--label-action'>Tıkla</span>" :allow-multiple="false" accepted-file-types="image/jpeg, image/png"  @addfile="onAddFile" />
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                            <label>Slug</label>
                            <el-input placeholder="Harika Stok Görselleri veya harika-stok-gorselleri" v-model="form.slug"></el-input>
                        </div>
                        <div class="form-group mb-2">
