...
<app-layout title="Bloglar">
    <div class="row">
        <div class="col-sm-12 col-lg-12 col-md-12">
            <el-page-header @back="goBack" title="Geri" content="Bloglar">
            </el-page-header>
                            ...
                            <el-table-column label="İşlem" width="200">
                                <template #default="scope">
                                    <el-button icon="el-icon-edit" size="mini"  v-on:click="
                                        ...
                                        ">Düzenle</el-button>
                                    <el-button type="danger" icon="el-icon-delete" size="mini" v-on:click="confirmDelete(scope.row.id, 'admin.blog.destroy', deleteMessage)">
                                        Sil
                                    </el-button>
                                </template>
                            </el-table-column>
