...
<div class="bg-light min-vh-100 d-flex flex-row align-items-center login" style="background-image: url(/assets/img/login-bgfyv.jpeg); background-size: cover; background-repeat: no-repeat; background-position: center;">
    <div class="container">
