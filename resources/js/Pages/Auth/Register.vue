                ...
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-4 mb-0">
                        <div class="card-body">
                            ...
                            <p class="text-medium-emphasis">Yeni Bir Hesap Kaydı</p>
                            <form @submit.prevent="submit">
                                <div class="input-group mb-3">
                                    <span class="input-group-text">
                                        <i class="fad fa-user"></i>
                                    </span>
                                    <input class="form-control" type="text" placeholder="Adı Soyadı" v-model="form.name" required autofocus autocomplete="name" />
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" type="email" placeholder="E-posta" v-model="form.email" required  />
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" type="password" placeholder="Şifre" v-model="form.password" required autocomplete="new-password" />
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" type="password" placeholder="Şifre Onayı" v-model="form.password_confirmation" required autocomplete="new-password" />
                                </div>
