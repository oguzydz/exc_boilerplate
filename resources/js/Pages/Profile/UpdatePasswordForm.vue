<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Güvende kalmak için hesabınızın şifresini uzun ve güvenli olmasına dikkat edin!
        </template>

        <template #form>
            <div class="col-span-6">
                <jet-label for="current_password" value="Mevcut Şifre" />
            ...
            <div class="col-span-6">
                <jet-label for="password_confirmation" value="Yeni Şifre Tekrar" />
