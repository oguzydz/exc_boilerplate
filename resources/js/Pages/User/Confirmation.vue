                ...
                <div class="step-tab-content">
                    <div class="row" v-if="active === 0 && userStatus !== 4">
                        <div class="col-md-6 form-info-side">
                            <el-alert v-if="userStatus === 5" title="Başvurunuz Rededildi:" type="error" show-icon
                                class="mb-4 mt-xs-3">
                        ...
                        <div class="col-md-6">
                            <el-form :model="firstForm" :rules="rules" ref="firstForm" label-width="130px"
                                ...
                                <el-form-item label="Ad-Soyad:" prop="name">
                                    <el-input v-model="firstForm.name" placeholder="Adınızı ve soyadınız."></el-input>
                                </el-form-item>
                                <el-form-item label="T.C. Numarası:" prop="tc">
                                    <el-input v-model="firstForm.tc" type="number" maxlength="11"
                                        placeholder="T.C. kimlik numaranız."></el-input>
                                </el-form-item>
                                <el-form-item label="Doğum Tarihi:" required>
                                    <el-form-item prop="born_date">
                                        <el-date-picker type="date" placeholder="Doğum tarihiniz."
                                            v-model="firstForm.born_date" format="DD-MM-YYYY" value-format="DD-MM-YYYY"
                                            style="width: 100%"></el-date-picker>
                                    </el-form-item>
                                </el-form-item>
                                <el-form-item label="Telefon Numarası:" prop="phone">
                                    <el-input v-model="firstForm.phone" type="number" maxlength="11"
                                        placeholder="Cep telefonu numaranız."></el-input>
                                </el-form-item>
                                <el-form-item label="Adres:" prop="address">
                                    <el-input type="textarea" v-model="firstForm.address" placeholder="Açık adresiniz.">
                                    </el-input>
                                </el-form-item>
                                ...
                                <div class="float-right">
                                    <el-button type="info" icon="el-icon-edit" @click="back('secondForm')">Geri
                                    </el-button>
                            ...
                            <el-form :model="secondForm" :rules="secondRules" ref="secondForm" label-width="130px"
                                ...
                                ">
                                    <el-form-item label="Şirket Ünvanı:" prop="corporate_name">
                                        <el-input v-model="secondForm.corporate_name" placeholder="Şirket ünvanınız.">
                                        </el-input>
                                    </el-form-item>
                                    <el-form-item label="Vergi Dairesi:" prop="tax_office">
                                        <el-input v-model="secondForm.tax_office" placeholder="Vergi daireniz.">
                                        </el-input>
                                    </el-form-item>
                                    <el-form-item label="Vergi Kimlik No:" prop="taxpayer_identification_number">
                                        <el-input v-model="secondForm.taxpayer_identification_number" type="number"
                                            maxlength="50" placeholder="Vergi kimlik numaranız (V.K.N.)."></el-input>
                                    </el-form-item>
                                </span>

                                <el-form-item label="IBAN:" prop="iban">
                                    <el-input v-model="secondForm.iban" type="number" maxlength="24"
                                        placeholder="Iban, TL hesabınız."></el-input>
                                </el-form-item>
                                <div class="float-right">
                                    <el-button type="info" icon="el-icon-edit" @click="back()">Geri</el-button>
                                    <el-button type="success" icon="el-icon-check" @click="submitForm('secondForm')">
                                        İLERLE</el-button>
                                </div>
                            </el-form>
                        </div>
                    ...
                    <div class="row" v-if="active === 2 && userStatus !== 4">
                        ...
                        <div class="col-md-6">
                            ...
                            <el-form :model="fourthForm" :rules="fourthRules" ref="fourthForm" label-width="130px"
                                :label-position="isMobile() ? 'left' : 'right'" size="medium">
                                <el-form-item label="Mağaza Adı:" prop="title">
                                    <el-input v-model="fourthForm.title" placeholder="Mağaza adınız."></el-input>
                                </el-form-item>

                                <el-form-item label="Mağaza Açıklama:" prop="text">
                                    <el-input type="textarea" v-model="fourthForm.text" rows="4"
                                        placeholder="Sitede görünecek mağaza açıklamanız."></el-input>
                                </el-form-item>
                            </el-form>

                            <el-form :model="thirdForm" :rules="thirdRules" ref="thirdForm" label-width="130px"
                                :label-position="isMobile() ? 'left' : 'right'" size="medium">
                                <el-form-item label="Ürün Özeti:" prop="service_text">
                                    <el-input type="textarea" v-model="thirdForm.service_text" rows="4"
                                        placeholder="Satılan ürün veya hizmet hakkında bilgi."></el-input>
                                </el-form-item>
                                <div class="float-right">
                                    <el-button type="info" icon="el-icon-edit" @click="back()">Geri</el-button>
                                    <el-button type="success" icon="el-icon-check" @click="submitForm('thirdForm')">
                                        GÖNDER</el-button>
                                </div>
                            </el-form>
                        </div>
