        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-10 text-center">
                <div class="section-title">
                    ...
                    <p>Haber bültenine kayıt olarak, mağazamızın tüm indirimlerinden ve kampanyalarından haberdar
                        olabilirsiniz!</p>
                </div>
                ...
                <div class="col-xl-9 col-lg-11">
                    ...
                    <div class="footer-widget widget widget_nav_menu shop-side text-center">
                        <ul>
                            ...
                            <li><a href="{{ route('policy.index') }}" target="blank">Gizlilik Ve Koşullar</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="row custom-gutters-16">
                            <div class="col-lg-9">
                                <div class="copyright-text">
                                    © <a href="{{ route("$company->slug.index") }}">{{ $company->title }}</a> - Tüm
                                    Hakları Saklıdır! ve <a
                                        href="{{ route("$company->slug.index") }}">{{ $company->title }}</a> bir <a
                                        href="{{ route('home') }}" target="_blank"><i
                                            class="fa fa-heart"></i><span>Exxefy</span></a> mağazasıdır.
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <ul class="social-icon text-right">
                                    <li>
                                        <a class="facebook" href="{{ $company->facebook }}" target="_blank"><i
                                                class="fa fa-facebook"></i></a>
                                    </li>
                                    <li>
                                        <a class="twitter" href="{{ $company->twitter }}" target="_blank"><i
                                                class="fa fa-twitter"></i></a>
                                    </li>
                                    <li>
                                        <a class="pinterest" href="{{ $company->instagram }}" target="_blank"><i
