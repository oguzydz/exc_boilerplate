            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center w-100">
                        ...
                        <p>
                            Aşağıdaki formu doldurarak mağazaya mesaj gönderebilir veya en altta yer alan iletişim bilgileri
                            yardımıyla
                    ...
                    <div class="col-lg-12 desktop-center-item">
                        <div>
                            <div class="contact-info">
                                ...
                                @endif
                                <p><span>Logo:</span>
                                    <img class="img d-block mt-2" src="/storage/{{ $company->logo }}"
                                        style="max-width: 100px" alt="profile">
                                </p>
                            </div>
                        </div>
                    </div>
