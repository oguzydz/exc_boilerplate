@extends('layouts.web')
@section('title', 'Ürünler - Exxestock')


@section('content')

    <x-pageTitle title="Ürünler" />
        ...
        <div class="container">
            @foreach ($categories as $category)
                <div class="row section-padding-100-0">
                    ...
                    @foreach ($category->productsWithLimit as $product)
                                ...
                                <div class="inner-box pl-0 text-center">
                                    <div class="mb-3">
                                        <a href="{{ route('product.show.' . $product->slug) }}"><img
                                                src="storage/{{ $product->image }}" alt=""></a>
                                    </div>
                                    <h3><a
                                            ...
                                            @foreach ($product->features as $feature)
                                                <div class="col-md-12">
                                                    <div class="side-feature-list-item justify-content-center">
                                                        <img src="img/features/feature-6.svg" class="check-mark-icon"
                                                            alt="">
                    ...
                    <div class="col-md-12 text-center">
                        <a class="btn info-btn mt-20 " data-wow-delay="0.6s"
                            ...
                            Kategorideki Tüm Ürünlere Gözat
                        </a>
                    </div>
                </div>
            @endforeach
